!function (t, e, i, n) {
    var a = e.document, o = t(a), r = t(e), s = Array.prototype, l = 1.41, c = true, u = 3e4, h = false, f = navigator.userAgent.toLowerCase(), d = e.location.hash.replace(/#\//, ""), p = e.location.protocol, g = Math, m = function () {
        ...
        return {
            clearTimer: function (e) {
                ...
                var r = {
                    _default: [.25, .1, .25, 1],
                    gallery: [.645, .045, .355, 1],
                    galleryIn: [.55, .085, .68, .53],
                    galleryOut: [.25, .46, .45, .94],
                    ease: [.25, 0, .25, 1],
                    linear: [.25, .25, .75, .75],
                    "ease-in": [.42, 0, 1, 1],
                    "ease-out": [0, 0, .58, 1],
                ...
                if (typeof r === "function") {
                    var u = t("<s>").attr("id", "gallery-loader").hide().appendTo(_().body);
                    H.wait({
                        until: function () {
                            return u.height() == 1
                        }, success: function () {
                            ...
                            u.remove();
                            i.raise("Theme CSS could not load after 20 sec. " + (i.QUIRK ? "Your browser is in Quirks Mode, please add a correct doctype." : "Please download the latest theme at http://gallery.io/customer/."), true)
                        }, timeout: 5e3
                    })
                }
                return s
        ...
        var i = ".gallery-videoicon{width:60px;height:60px;position:absolute;top:50%;left:50%;z-index:1;" + "margin:-30px 0 0 -30px;cursor:pointer;background:#000;background:rgba(0,0,0,.8);border-radius:3px;-webkit-transition:all 150ms}" + ".gallery-videoicon i{width:0px;height:0px;border-style:solid;border-width:10px 0 10px 16px;display:block;" + "border-color:transparent transparent transparent #ffffff;margin:20px 0 0 22px}.gallery-image:hover .gallery-videoicon{background:#000}";
        H.insertStyleTag(i, "gallery-videoicon");
        return t(H.create("gallery-videoicon")).html("<i></i>").appendTo(e).click(function () {
    ...
    i = function () {
        ...
        t.each(l.split(" "), function (t, e) {
            s._dom[e] = H.create("gallery-" + e)
        });
        t.each(c.split(" "), function (t, e) {
            s._dom[e] = H.create("gallery-" + e, "span")
        });
        ...
        var d = this._carousel = {
            ...
            update: function () {
                ...
                d.setClasses();
                s.$("thumbnails-container").toggleClass("gallery-carousel", e > d.width);
                d.width = s.$("thumbnails-list").width()
            },
        ...
        var p = this._tooltip = {
            ...
            init: function () {
                p.initialized = true;
                var t = ".gallery-tooltip{padding:3px 8px;max-width:50%;background:#ffe;color:#000;z-index:3;position:absolute;font-size:11px;line-height:1.3;" + "opacity:0;box-shadow:0 0 2px rgba(0,0,0,.4);-moz-box-shadow:0 0 2px rgba(0,0,0,.4);-webkit-box-shadow:0 0 2px rgba(0,0,0,.4);}";
                H.insertStyleTag(t, "gallery-tooltip");
        ...
        var w = this._lightbox = {
            ...
            init: function () {
                ...
                o += ".gallery-" + l + "box.iframe .gallery-" + l + "prevholder," + ".gallery-" + l + "box.iframe .gallery-" + l + "nextholder{" + "width:100px;height:100px;top:50%;margin-top:-70px}";
                H.insertStyleTag(o, "gallery-lightbox");
            ...
            show: function (n) {
                ...
                t(w.image.container).find(".gallery-videoicon").remove();
    ...
    i.prototype = {
        constructor: i, init: function (e, a) {
            ...
            if (i.QUIRK) {
                i.raise("Your page is in Quirks mode, Gallery may not render correctly. Please validate your HTML and add a correct doctype.")
            }
            if (z.length) {
            ...
            this.$("container").addClass([i.TOUCH ? "touch" : "notouch", this._options.variation, "gallery-theme-" + this.theme.name].join(" "));
            if (!this._options.swipe) {
                t.each(new Array(2), function (e) {
                    ...
                    t(n.container).css({
                        ...
                        top: 0,
                        left: 0
                    }).prepend(o._layers[e] = t(H.create("gallery-layer")).css({
                        position: "absolute",
                        top: 0,
                        left: 0,
                        right: 0,
                    ...
                    var a = new i.Picture;
                    a.isIframe = true;
                    t(a.container).attr("class", "gallery-frame").css({
                        position: "absolute",
                        top: 0,
                        left: 0,
                        zIndex: 4,
            ...
            if (s.swipe) {
                ...
                this.finger = new i.Finger(this.get("stage"), {
                    onchange: function (t) {
                        ...
                        o.$("images").find(".gallery-frame").css("opacity", 0).hide().find("iframe").remove();
            ...
            var o, r, s, l, c = this, u = this._options, h = n ? this._data.length - n.length : 0, f = h, d = [], p = 0, g = y < 8 ? "http://upload.wikimedia.org/wikipedia/commons/c/c0/Blank.gif" : "data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw%3D%3D", m = function () {
                ...
                return function () {
                    t(a).append(e);
                    c.trigger({type: i.THUMBNAIL, thumbTarget: e, index: n, galleryData: c.getData(n)})
                }
            }, w = function (e) {
                ...
                c.trigger({
                    ...
                    thumbTarget: e.image,
                    index: e.data.order,
                    galleryData: c.getData(e.data.order)
                });
            ...
            for (; this._data[h]; h++) {
                ...
                if ((u.thumbnails === true || v == "lazy") && (s.thumb || s.image)) {
                    ...
                    r = {
                        container: H.create("gallery-image"),
                ...
                timeout: 1e4, until: function () {
                    ...
                    if (a._options.swipe) {
                        ...
                        t.each(new Array(a.getDataLength()), function (e) {
                            ...
                            }).prepend(a._layers[e] = t(H.create("gallery-layer")).css({
                                position: "absolute",
                                top: 0,
                                left: 0,
                                right: 0,
                            ...
                            var s = new i.Picture;
                            s.isIframe = true;
                            t(s.container).attr("class", "gallery-frame").css({
                                position: "absolute",
                                top: 0,
                                left: 0,
                                zIndex: 4,
            ...
            this.$("target").data("gallery", null);
            this.$("container").off("gallery");
            ...
            if (r) {
                ...
                var p = {cached: f, index: n, rewind: a, imageTarget: h.image, thumbTarget: d.image, galleryData: l};
            ...
            var p = function (o, r, l, c, u) {
                return function () {
                    ...
                    t(l.container).find("iframe, .gallery-videoicon").remove();
                ...
                t(function () {
                    ...
                    var s = function () {
                        t("script").each(function (t, i) {
                            o = new RegExp("gallery\\." + n.name.toLowerCase() + "\\.");
                            if (o.test(i.src)) {
                                a = i.src.replace(/[^\/]*$/, "") + n.css;
                                e.setTimeout(function () {
                                    H.loadCSS(a, "gallery-theme-" + n.name, function () {
                                        F(n)
                                    })
                                }, 1)
                            }
        ...
        t(e).load(function () {
            if (!o) {
                r = e.setTimeout(function () {
                    if (!o) {
                        i.raise("Gallery had problems loading theme at " + n + ". Please check theme path or load manually.", true)
                    }
                }, 2e4)
            }
        });
    ...
    i.requires = function (t, e) {
        e = e || "You need to upgrade Gallery to version " + t + " to use one or more components.";
        if (i.version < t) {
            i.raise(e, true)
        }
        return i
    ...
    i.Picture = function (e) {
        this.id = e || null;
        this.image = null;
        this.container = H.create("gallery-image");
    ...
    t.extend(t.easing, {
        gallery: function (t, e, i, n, a) {
            if ((e /= a / 2) < 1) {
                return n / 2 * e * e * e + i
            }
            return n / 2 * ((e -= 2) * e * e + 2) + i
        }, galleryIn: function (t, e, i, n, a) {
            return n * (e /= a) * e + i
        }, galleryOut: function (t, e, i, n, a) {
            return -n * (e /= a) * (e - 2) + i
        }
    });
    i.Finger = function () {
    ...
    t.fn.gallery = function (e) {
                ...
                if (t(n).length) {
                    ...
                    i.utils.wait({
                        until: function () {
                            ...
                            i.raise('Init failed: Gallery could not find the element "' + n + '".')
                        }, timeout: 5e3
                    })
                }
            });
        ...
        return this.each(function () {
            if (t.data(this, "gallery")) {
                t.data(this, "gallery").destroy();
                t(this).find("*").hide()
            }
            t.data(this, "gallery", (new i).init(this, e))
        })
    };
    if (typeof module === "object" && module && typeof module.exports === "object") {
        ...
        if (typeof define === "function" && define.amd) {
            define("gallery", ["jquery"], function () {
                return i
            })
        }
    }
